...
typedef enum AnimType : char
{
    ...
    ANIM_TS_SONICPULSE, // TS Disruptor sonic pulse: an off-colour disc riding the band every SONIC_PULSE_EVERY discs, art lit only in a short stage window so the stage offset along the band makes it travel tank->target.
