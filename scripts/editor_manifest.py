...
BUILDINGS = [
    ...
    # Faction-split yards / factories / helipads and the TS tree (ids follow defines.h;
    # sizes and occupancy from the bdata.cpp ctors; names and stats from CCDATA/rules.ini).
    # Multi-owner TS buildings carry GoodGuy so the editor groups them with TS GDI.
    {'id': 112, 'name': 'tspowr', 'display_name': 'Tiberian Power Plant', 'power_production': 100, 'power_usage': 0, 'storage': 0, 'capturable': True, 'width': 2, 'height': 2, 'occupy_mask': '00 11', 'owner': 'GoodGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Bib']},
    {'id': 113, 'name': 'tdnfact', 'display_name': 'Nod Construction Yard', 'power_production': 0, 'power_usage': 0, 'storage': 0, 'capturable': True, 'width': 3, 'height': 2, 'occupy_mask': None, 'owner': 'BadGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Factory', 'Bib']},
    {'id': 114, 'name': 'tdgfact', 'display_name': 'GDI Construction Yard', 'power_production': 0, 'power_usage': 0, 'storage': 0, 'capturable': True, 'width': 3, 'height': 2, 'occupy_mask': None, 'owner': 'GoodGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Factory', 'Bib']},
    {'id': 115, 'name': 'tdghpad', 'display_name': 'GDI Helipad', 'power_production': 0, 'power_usage': 10, 'storage': 0, 'capturable': True, 'width': 2, 'height': 2, 'occupy_mask': None, 'owner': 'GoodGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Bib']},
    {'id': 116, 'name': 'tdnhpad', 'display_name': 'Nod Helipad', 'power_production': 0, 'power_usage': 10, 'storage': 0, 'capturable': True, 'width': 2, 'height': 2, 'occupy_mask': None, 'owner': 'BadGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Bib']},
    {'id': 117, 'name': 'sfact', 'display_name': 'Soviet Construction Yard', 'power_production': 0, 'power_usage': 0, 'storage': 0, 'capturable': True, 'width': 3, 'height': 3, 'occupy_mask': None, 'owner': 'USSR', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Factory', 'Bib']},
    {'id': 118, 'name': 'afact', 'display_name': 'Allied Construction Yard', 'power_production': 0, 'power_usage': 0, 'storage': 0, 'capturable': True, 'width': 3, 'height': 3, 'occupy_mask': None, 'owner': 'Greece', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Factory', 'Bib']},
    {'id': 119, 'name': 'aweap', 'display_name': 'Allied War Factory', 'power_production': 0, 'power_usage': 30, 'storage': 0, 'capturable': True, 'width': 3, 'height': 2, 'occupy_mask': None, 'owner': 'Greece', 'factory_overlay': 'aweap2', 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Bib']},
    {'id': 120, 'name': 'sweap', 'display_name': 'Soviet War Factory', 'power_production': 0, 'power_usage': 30, 'storage': 0, 'capturable': True, 'width': 3, 'height': 2, 'occupy_mask': None, 'owner': 'USSR', 'factory_overlay': 'sweap2', 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Bib']},
    {'id': 121, 'name': 'ahpad', 'display_name': 'Allied Helipad', 'power_production': 0, 'power_usage': 10, 'storage': 0, 'capturable': True, 'width': 2, 'height': 2, 'occupy_mask': None, 'owner': 'Greece', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Bib']},
    {'id': 122, 'name': 'shpad', 'display_name': 'Soviet Helipad', 'power_production': 0, 'power_usage': 10, 'storage': 0, 'capturable': True, 'width': 2, 'height': 2, 'occupy_mask': None, 'owner': 'USSR', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Bib']},
    {'id': 123, 'name': 'tsfact', 'display_name': 'TS Construction Yard', 'power_production': 0, 'power_usage': 0, 'storage': 0, 'capturable': True, 'width': 3, 'height': 2, 'occupy_mask': None, 'owner': 'GoodGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Factory', 'Bib']},
    {'id': 124, 'name': 'tspile', 'display_name': 'TS Barracks', 'power_production': 0, 'power_usage': 20, 'storage': 0, 'capturable': True, 'width': 2, 'height': 1, 'occupy_mask': None, 'owner': 'GoodGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Bib']},
    {'id': 125, 'name': 'tsproc', 'display_name': 'TS Tiberium Refinery', 'power_production': 0, 'power_usage': 30, 'storage': 2000, 'capturable': True, 'width': 4, 'height': 3, 'occupy_mask': '1110 1100 0000', 'owner': 'GoodGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': []},
    {'id': 126, 'name': 'tssilo', 'display_name': 'TS Tiberium Silo', 'power_production': 0, 'power_usage': 10, 'storage': 60, 'capturable': True, 'width': 2, 'height': 2, 'occupy_mask': None, 'owner': 'GoodGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': []},
    {'id': 127, 'name': 'tsweap', 'display_name': 'TS War Factory', 'power_production': 0, 'power_usage': 30, 'storage': 0, 'capturable': True, 'width': 5, 'height': 3, 'occupy_mask': '11110 11110 00000', 'owner': 'GoodGuy', 'factory_overlay': 'tsweap2', 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': []},
    {'id': 128, 'name': 'tsradr', 'display_name': 'TS Radar', 'power_production': 0, 'power_usage': 40, 'storage': 0, 'capturable': True, 'width': 2, 'height': 2, 'occupy_mask': '00 11', 'owner': 'GoodGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Bib']},
    {'id': 129, 'name': 'tshpad', 'display_name': 'TS Helipad', 'power_production': 0, 'power_usage': 10, 'storage': 0, 'capturable': True, 'width': 2, 'height': 2, 'occupy_mask': None, 'owner': 'GoodGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': []},
    {'id': 130, 'name': 'tstech', 'display_name': 'TS Tech Center', 'power_production': 0, 'power_usage': 200, 'storage': 0, 'capturable': True, 'width': 3, 'height': 2, 'occupy_mask': None, 'owner': 'GoodGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Bib']},
    {'id': 131, 'name': 'tsdept', 'display_name': 'TS Service Depot', 'power_production': 0, 'power_usage': 30, 'storage': 0, 'capturable': True, 'width': 3, 'height': 3, 'occupy_mask': '010 111 010', 'owner': 'GoodGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'paved', 'flags': []},
    {'id': 132, 'name': 'tsdrop', 'display_name': 'Dropship Bay', 'power_production': 0, 'power_usage': 100, 'storage': 0, 'capturable': True, 'width': 3, 'height': 2, 'occupy_mask': None, 'owner': 'GoodGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': ['Bib']},
    {'id': 133, 'name': 'tsturb', 'display_name': 'Power Turbine', 'power_production': 50, 'power_usage': 0, 'storage': 0, 'capturable': False, 'width': 1, 'height': 1, 'occupy_mask': None, 'owner': 'GoodGuy', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': []},
    ...
    {'id': 143, 'name': 'tsdlimp', 'display_name': 'Limpet Mine', 'power_production': 0, 'power_usage': 0, 'storage': 0, 'capturable': False, 'width': 1, 'height': 1, 'occupy_mask': None, 'owner': 'Germany', 'factory_overlay': None, 'frame_offset': 0, 'graphics_source': None, 'z_order': 'default', 'flags': []},
]
...
UNITS = [
    ...
    # TS vehicles + faction-split MCVs (ids follow defines.h; turret facts from the
    # udata.cpp ctors, names from CCDATA/rules.ini). Walkers pack the body as facing
    # blocks of walk_frames (standing frame = facing * walk_frames; unit.cpp gait
    # contract) — TSTITN/TSSMEC 8 facings x 12, TSHMEC 32 x 8; TSTITN's 32-facing
    # turret block sits right after the body (96-127). The TSMDIV purchase token
    # (id 49) never touches the map and is deliberately absent.
    {'id': 37, 'kind': 'vehicle', 'name': 'tshvr', 'display_name': 'Hover MLRS', 'owner': 'GoodGuy', 'body_frames': ['Frames32Full'], 'turret_frames': ['Frames32Full'], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': ['Turret', 'Armed']},
    {'id': 38, 'kind': 'vehicle', 'name': 'tstitn', 'display_name': 'Titan', 'owner': 'GoodGuy', 'body_frames': ['Frames08Cardinal'], 'walk_frames': 12, 'turret_frames': ['Frames32Full'], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': ['Turret', 'Armed']},
    {'id': 53, 'kind': 'vehicle', 'name': 'tsjugg', 'display_name': 'Juggernaut', 'owner': 'Germany', 'body_frames': ['Frames08Cardinal'], 'walk_frames': 15, 'turret_frames': [], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': ['Armed']},
    {'id': 54, 'kind': 'vehicle', 'name': 'tslimp', 'display_name': 'Limpet Drone', 'owner': 'Germany', 'body_frames': ['Frames01Single'], 'turret_frames': [], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': []},
    {'id': 39, 'kind': 'vehicle', 'name': 'tshmec', 'display_name': 'Mammoth Mk. II', 'owner': 'GoodGuy', 'body_frames': ['Frames32Full'], 'walk_frames': 8, 'turret_frames': [], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': ['Armed']},
    {'id': 40, 'kind': 'vehicle', 'name': 'smcv', 'display_name': 'Soviet MCV', 'owner': 'USSR', 'body_frames': ['Frames32Full'], 'turret_frames': [], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': ['BuildingRemap']},
    {'id': 41, 'kind': 'vehicle', 'name': 'tdnmcv', 'display_name': 'Nod MCV', 'owner': 'BadGuy', 'body_frames': ['Frames32Full'], 'turret_frames': [], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': ['BuildingRemap']},
    {'id': 42, 'kind': 'vehicle', 'name': 'tdgmcv', 'display_name': 'GDI MCV', 'owner': 'GoodGuy', 'body_frames': ['Frames32Full'], 'turret_frames': [], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': ['BuildingRemap']},
    {'id': 43, 'kind': 'vehicle', 'name': 'amcv', 'display_name': 'Allied MCV', 'owner': 'Greece', 'body_frames': ['Frames32Full'], 'turret_frames': [], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': ['BuildingRemap']},
    {'id': 44, 'kind': 'vehicle', 'name': 'tsmcv', 'display_name': 'TS Mobile Construction Vehicle', 'owner': 'GoodGuy', 'body_frames': ['Frames32Full'], 'turret_frames': [], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': ['BuildingRemap']},
    {'id': 45, 'kind': 'vehicle', 'name': 'tsharv', 'display_name': 'TS Harvester', 'owner': 'GoodGuy', 'body_frames': ['Frames32Full'], 'turret_frames': [], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': ['Harvester', 'BuildingRemap']},
    {'id': 46, 'kind': 'vehicle', 'name': 'tssmec', 'display_name': 'Wolverine', 'owner': 'GoodGuy', 'body_frames': ['Frames08Cardinal'], 'walk_frames': 12, 'turret_frames': [], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': ['Armed']},
    {'id': 47, 'kind': 'vehicle', 'name': 'tssonic', 'display_name': 'Disruptor', 'owner': 'GoodGuy', 'body_frames': ['Frames32Full'], 'turret_frames': ['Frames32Full'], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': ['Turret', 'Armed']},
    ...
    {'id': 13, 'kind': 'aircraft', 'name': 'tsorca', 'text_id': 'TEXT_UNIT_TSORCA', 'owner': 'Germany', 'body_frames': ['Frames32Full'], 'turret_frames': [], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': ['Armed']},
    {'id': 14, 'kind': 'aircraft', 'name': 'tsorcab', 'text_id': 'TEXT_UNIT_TSORCAB', 'owner': 'Germany', 'body_frames': ['Frames32Full'], 'turret_frames': [], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': ['Armed']},
    {'id': 15, 'kind': 'aircraft', 'name': 'tscarry', 'text_id': 'TEXT_UNIT_TSCARRY', 'owner': 'Germany', 'body_frames': ['Frames32Full'], 'turret_frames': [], 'turret': None, 'turret2': None, 'turret_offset': 0, 'turret_y': 0, 'flags': []},
