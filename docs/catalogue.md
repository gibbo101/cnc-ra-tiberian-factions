...
- TD-themed vehicles per faction — **✅ GDI Medium Tank (TDMTNK) shipped 2026-05-30** (first combat vehicle; pipeline in `td-vehicle-port-recipe.md`). Remaining: NOD Light Tank, GDI Mammoth Tank, Buggy, Recon Bike, Flame/Stealth Tank, MLRS, APC, Artillery.
